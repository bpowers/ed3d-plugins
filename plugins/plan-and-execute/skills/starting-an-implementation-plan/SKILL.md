...
**Cross-agent compatibility:** When this skill mentions Claude Code-specific tools or commands (`TaskCreate`, `TaskUpdate`, `AskUserQuestion`, `/clear`), use your current agent's equivalent.
...
1. **REQUIRED SUB-SKILL:** Use plan-and-execute:using-git-worktrees
...
**REQUIRED SUB-SKILL:** Use plan-and-execute:writing-implementation-plans
...
cat /path/to/plugins/plan-and-execute/skills/starting-an-implementation-plan/SKILL.md
```
...
/plan-and-execute:execute-implementation-plan /Users/ed/project/.worktrees/oauth2-feature/docs/implementation-plans/2025-01-17-oauth2-feature/ /Users/ed/project/.worktrees/oauth2-feature/
