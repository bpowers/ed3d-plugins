...
**REQUIRED BACKGROUND:** Read plan-and-execute:writing-claude-directives for foundational guidance on token efficiency, discovery optimization, and compliance techniques. This skill focuses on TDD methodology specific to skill creation.
...
**REQUIRED:** Use plan-and-execute:testing-skills-with-subagents for complete methodology.
