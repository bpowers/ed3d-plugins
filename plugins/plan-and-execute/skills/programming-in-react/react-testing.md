...
**ALWAYS use plan-and-execute:codebase-investigator to find existing test patterns before writing tests.**
...
Check codebase for existing patterns with plan-and-execute:codebase-investigator.
