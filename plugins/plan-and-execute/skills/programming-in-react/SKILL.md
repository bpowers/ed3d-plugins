...
**REQUIRED SUB-SKILL:** Use plan-and-execute:howto-code-in-typescript for general TypeScript patterns. This skill covers React-specific TypeScript usage only.
