...
**REQUIRED SUB-SKILL:** Use plan-and-execute:asking-clarifying-questions
...
**REQUIRED SUB-SKILL:** Use plan-and-execute:brainstorming
...
**REQUIRED SUB-SKILL:** Use plan-and-execute:writing-design-plans
...
```
/plan-and-execute:start-implementation-plan @docs/design-plans/[full-filename].md .
```
